...
<AccordionGroup>
  ...
  <Accordion title="RapidAPI subscriptions cannot use MCP">
    ...
    Everything is available over REST through RapidAPI exactly as documented. MCP needs a direct Prefetch key from the [dashboard](https://prefetch.io/dashboard).
  </Accordion>
